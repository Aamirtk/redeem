...
<body class="bg-grey1 mw1200">
            ...
            <div class="caseupload-form-box">
                <div class="caseupload-form-row clear-float">
                    ...
                    <div class="caseupload-form-middle fl clear-float">
                        ...
                        <input type="hidden" id="work_url" name="work_url" value="">
                    </div>
                ...
                <div class="caseupload-form-row clear-float">
                    ...
                    <div class="caseupload-form-middle fl clear-float">
                        <input type="text" class="form-control" id="work_price" name="work_price">
                    </div>
                    <div class="caseupload-form-right h36 fl"></div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function createWork() {
            ...
            var obj_username = "<?= $this->context->company['username'] ?>";
            $.ajax({
                type: "POST",
                dataType: "json",
                async: false,
                ...
                url: "/enterprise/work/create?username=" + obj_username,
                success: function (json) {
                    if (json.result) {
                        window.location.href = "/enterprise/work/list/" + obj_username;
                    }
                    else {
                        alert(json.msg);
                    }
