...
<head lang="en">
    ...
    <link type="text/css" rel="stylesheet" href="/plugins/umeditor/themes/default/css/umeditor.css">
                    ...
                    <form id="extend_form" method="post" actoin="">
                        <div class="upload-area">
                            <div class="table-cell">
                                ...
                                <div class="form_box">
                                    <label>项目介绍：</label>
                                    <script type="text/plain" id="editor_proj_desc" name="editor_proj_desc" style="width: 480px; height: 250px;"></script>
                                    <br class="clear"/>
                                </div>
                                <div class="form_box">
                                    <label>团队介绍：</label>
                                    <script type="text/plain" id="editor_team_desc" name="editor_team_desc" style="width: 480px; height: 250px;"></script>
                                    <br class="clear"/>
                                </div>
                                <div class="form_box">
                                    <div>
                                        <label>团队成员：</label>
                                        <div class="placeholder-box">
                                            <input type="text" id="proj_member_str" name="proj_member_str" class="form-control" value="" placeholder="可输入用户名/昵称/手机/邮箱">
                                        </div>
                                        <ul class="add-member-box">
                                            <li>
                                                <a href="javascript:void(0);">
                                                    <div class="member-box-portrait">
                                                        <img src="/images/demo-p2.jpg">
                                                    </div>
                                                    <div class="member-box-name">
                                                        泡腾片
                                                    </div>
                                                </a>
                                            </li>
                                        ...
                                        <span class="form-intro">请输入平台注册账号，逗号分隔，最多5名成员</span>
                                    </div>
                                    <div class="add-member-list">
                                        <ul>
                                            <li>
                                                <div class="member-list-portrait">
                                                    <img src="/images/demo-p2.jpg">
                                                </div>
                                                <div class="member-list-name">
                                                    啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊
                                                </div>
                                                <a class="member-list-close"></a>
                                            </li>
                                            <li>
                                                <div class="member-list-portrait">
                                                    <img src="/images/demo-p2.jpg">
                                ...
                                <div class="form_box">
                                    <label>为何入驻：</label>
                                    <script type="text/plain" id="editor_remarks" name="editor_remarks" style="width: 480px; height: 250px;"></script>
                                    <br class="clear"/>
                                </div>
                                <div class="form_box">
                                    <label>项目风险：</label>
                                    <script type="text/plain" id="editor_proj_risk" name="editor_proj_risk" style="width: 480px; height: 250px;"></script>
                                    <br class="clear"/>
                                </div>
                                <div class="form_box">
                                    <label>答疑解惑：</label>
        ...
        if ($("#basic_form").length > 0) {
            ...
            $("#basic_form").validate({
                ...
                errorPlacement: function(error, element) {
                    error.appendTo(element.closest(".form_box"));
                },
                submitHandler: function(form){
                    ...
                    //实例化编辑器
                    umProjDesc = UM.getEditor('editor_proj_desc');  // 项目介绍
                    umTeamDesc = UM.getEditor('editor_team_desc');  // 团队描述
                    umRemarks = UM.getEditor('editor_remarks');     // 为何入驻
                    umProjRisk = UM.getEditor('editor_proj_risk');  // 项目风险
                }
            });
        }
    });
