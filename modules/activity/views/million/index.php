...
<div class="ds-index-wrap">
    ...
    <div class="ds-banner">
        <div class="ds-banner-slide specialSlide">
            ...
            <div class="bd">
                <ul>
                    <?php $banners = Banner::getBannerList(Banner::TYPE_MILLION, 10);?>
                        ...
                        <?php foreach ($hot_projs as $k => $v): ?>
                            <li<?php if ($k==0):?> class="active"<?php endif;?>>
                                <a target="_blank" href="/project/<?= $v['proj_id'] ?>">
                                    ...
                                    <img src="<?= $v['project']['proj_icon'] ?>" alt="<?= $v['project']['proj_name']?>" width="409" height="256">
                                    <?php if($v['is_new']):?>
                            ...
                            <?php foreach ($hot_projs as $k => $v): ?>
                                <div class="tab-content" style="display: <?php if ($k == 0): ?>block;<?php else: ?>none;<?php endif; ?>" >
                                    <div class="ds-img-box">
                                        <a target="_blank" href="/project/<?= $v['proj_id'] ?>">
                                            <img src="<?= $v['proj_pic'] ?>" alt="<?= $v['project']['proj_name']?>" class="ds-img-big">
                                        </a>
                                        <div class="ds-bar">
                                    ...
                                    <div class="ds-main-member-list">
                                        <?php foreach ($v['member_list'] as $mk => $mv): ?>
                                            <dl class="ds-main-member-img">
                                                <dt>
                                                    <a<?php if ($v['username']):?> target="_blank" href="/talent/<?= $mv['proj_member'] ?>"<?php endif;?>>
                    ...
                    <ul class="ds-project-ul">
                        <?php if (count($all_projs) > 0): ?>
                            <?php foreach ($all_projs as $k => $v): ?>
                                <li>
                                    <a target="_blank" href="/project/<?= $v['proj_id'] ?>" class="ds-project-img">
                                        <img src="<?= $v['project']['proj_icon'] ?>" alt="<?= $v['project']['proj_name']?>" width="291" height="166">
                                    </a>
                                    <div class="ds-project-info">
                                        <a class="ds-project-head"<?php if ($v['username']):?> target="_blank" href="/talent/<?= $v['username'] ?>"<?php endif;?>>
                                        ...
                                        <div class="ds-project-info-right">
                                            <p class="ds-project-title">
                                                <a target="_blank" href="/project/<?= $v['proj_id'] ?>">《<?=$v['project']['proj_name']?>》</a>
                                            </p>
        ...
        <div class="ds-1200">
            <div class="ds-part-title">
                <p>
                    ...
                    <a target="_blank" href="http://rc.vsochina.com" class="ds-part-link font-14">More +</a>
                </p>
            </div>
            <div class="ds-friend">
                    ...
                    <div class="friend-content" style="display:block;">
                        <ul class="friend-list">
                            <?php foreach ($enterprise as $k => $v): ?>
                                <li>
                                    <a href="/talent/<?= $v['username'] ?>" target="_blank">
