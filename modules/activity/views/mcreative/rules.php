...
<body>
    ...
    <div class="mcreative-banner mcreative-banner-two">
    ...
    <div class="mcreative-part mcreative-whitepart">
        <div class="mcreative-titlebox ds-1200 clearfix">
            <div class="mcreative-title">
                <b></b>
                <span class="mcreative-title-ch">参赛须知</span>
                <span class="mcreative-title-en">NOTICE</span>
            </div>
        </div>
        <div class="mcreative-knowledge ds-1200">
            <ul class="mcreative-knowledge-list">
                <li>
                    <span>1.</span>
                    <p>参赛者提交的项目以及项目相关作品不得涉及政治、敏感话题，不得包含或映射包含色情、暴力内容，如若发现违法相关规定的，主办方有权取消其参赛资格，并将立即删除违法内容，其法律责任由参赛者本人负担。</p>
                </li>
                <li>
                    <span>2.</span>
                    <p>参赛者在提交项目以及项目相关作品前请确保已经阅读并且愿意遵守相关比赛规则，任何违反比赛规则的作品，主办方有权取消其参赛资格。</p>
                </li>
                <li>
                    <span>3.</span>
                    <p>参赛者提交的参赛项目及项目相关作品均须为原创内容或未被商用或授权他人使用，不得抄袭、盗用他人作品，且版权未移交他人。若在比赛或商业应用过程中发生版权纠纷，其法律责任由参赛者本人承担。</p>
                </li>
                <li>
                    <span>4.</span>
                    <p>参赛期间，参赛者不得将参赛作品转让或授权给任何第三方，不得用参赛作品参与与本赛事相同或类似的其他活动。</p>
                </li>
                <li>
                    <span>5.</span>
                    <p>如团队合作项目，需征得所有合作者同意并在团队成员介绍处标明所有合作者姓名。</p>
                </li>
                <li>
                    <span>6.</span>
                    <p>同一个账号可上传多个项目，评选结果以项目为单位，即同一用户可获得多个奖项。</p>
                </li>
                <li>
                    <span>7.</span>
                    <p>为更好的展示参赛作品，请按照页面上的提示，尽量按照规定的大小、尺寸上传作品，尽可能的填写完善的资料。</p>
                </li>
                <li>
                    <span>8.</span>
                    <p>为保证本次赛事活动的公平公正，参赛作品不得添加任何与本次大赛无关的第三方LOGO、水印、文字暗示，一经发现将给予删除处理。</p>
                </li>
                <li>
                    <span>9.</span>
                    <p>在大赛征集期间如有任何疑议请发送相关材料至 bwds@landhightech.com。</p>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="mcreative-part mcreative-whitepart">
        <div class="mcreative-titlebox ds-1200 clearfix">
            <div class="mcreative-title">
                <b></b>
                <span class="mcreative-title-ch">相关权益</span>
                <span class="mcreative-title-en">RIGHTS</span>
            </div>
        </div>
        <div class="mcreative-rights ds-1200">
            <ul class="mcreative-knowledge-list">
                <li>
                    <span>1.</span>
                    <p>全部参赛项目以及项目相关作品，蓝海创意云平台以及苏州创意云网络科技公司拥有对作品的展示、报道、宣传、市场活动以及投资孵化等权益。</p>
                </li>
                <li>
                    <span>2.</span>
                    <p>全部参赛项目以及项目相关作品，无论是否获奖，作者保留除上述第一条以外的其作品权利。</p>
                </li>
                <li>
                    <span>3.</span>
                    <p>参赛选手不可随意从系统中删除已获奖的项目，如有特殊情况需要删改内容的，需要通知赛事主办方（bwds@landhightech.com）。</p>
                </li>
                <li>
                    <span>4.</span>
                    <p>若主办方需对参赛项目以及项目相关作品进行进一步完善或开发、设计周边产品，需得到作者书面同意授权。在实际制作过程中，获奖作者也可以提出建议、协助或参与其中。</p>
                </li>
                <li>
                    <span>5.</span>
                    <p>主办方如需对参赛项目或项目相关作品进行开发、生产、销售等商业用途，需取得作者书面许可，并向作者支付相应设计费用。</p>
                </li>
                <li>
                    <span>6.</span>
                    <p>主办方对本活动保留最终解释权。</p>
