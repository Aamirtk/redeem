...
<head>
    ...
    <title><?= $_work_info['work_name']." | ".$user_info['nickname'] ?></title>
...
<div class="rc-upload-wrap">
    <div class="rc-upload-box">
        <ul class="rc-upload-nav clear-float">
            <?php if ($_work_info['pic_or_video'] == 1)
            { ?>
                <li class="active">
                    <a>
            ...
            <?php if ($_work_info['pic_or_video'] == 2)
            { ?>
                <li class="active">
                    <a>
            ...
            <?php if ($_work_info['pic_or_video'] == 3)
            { ?>
                <li class="active">
                    <a>
            ...
            { ?>
                ...
                <div class="rc-upload-content active">
                    <form action="" method="post" class="_work_form">
                        ...
                        <div id="uploader_picture" class="uploader-one">
                            <?php if (!empty($_work_info['work_url']))
                            { ?>
                                <div id="rc_pictureList" class="uploader-list clearfix">
                                    <div class="uploader-listitem">
                                        <img src="<?php echo $_work_info['work_url'];?>"/>
                                        <input type="hidden" value="<?php echo $_work_info['work_url'];?>"
                                               name="work[workfile]"/>
                                        <a class="uploader-listitem-close" href="javascript:void(0);">×</a>
                                    </div>
                                </div>
                                <div id="rc_picturePicker">
                                    <p class="rc-picturePicker-txt"><i class="icon-13 icon-13-blueadd"></i>上传文件</p>
                                </div>
                            <?php }
                            else
                            { ?>
                        ...
                        <div class="upload-content-msg">
                            <div class="upload-content-title flag-placeholder">
                                <input type="text" class="form-control" placeholder="标题（可不填）" name="work[name]"
                                       autocomplete="off" value="<?php echo $_work_info['work_name']; ?>"/>
                            </div>
                        </div>
                        <div class="upload-content-msg">
                            <div class="upload-content-category dropdown">
                                ...
                                <span
                                    class="samplereels"><?php echo empty($_work_group_list[$_work_info['p_work_id']]) ? '选择所属作品集' : $_work_group_list[$_work_info['p_work_id']]['work_name']; ?></span>
                        ...
                        <div class="upload-content-msg">
                            <script type="text/plain" id="editor_upload_picture" name="work[content]"
                                    style="margin:10px 0;"><?php
                                if ($_work_info['pic_or_video'] == 1)
                                {
                                    echo $_work_info['description'];
                                }
                                ?></script>
                        </div>
                        <div class="upload-content-msg">
                            <div class="upload-content-tagwrap clearfix">
                                <?php if (!empty($_work_info['lable']))
                                { ?>
                                    <?php $lable_arr = explode(',', $_work_info['lable']); ?>
                                    <?php foreach ($lable_arr as $val)
                                { ?>
                                    <span class="upload-content-token">
                                        <?php echo $val; ?>
                                        <input type="hidden" value="<?php echo $val; ?>" name="work[tags][]">
                                    </span>
                                <?php } ?>
                                <?php } ?>
                        ...
                        <div class="upload-content-setting clearfix">
                            <div class="upload-content-copyright dropup">
                                <a class="copyright-btn _open_status_icon" href="javascript:void(0);"
                                ...
                                <ul class="dropdown-menu _chose_open_status" aria-labelledby="dLabel">
                                    <li <?php if ($_work_info['copyright'] == 1 && $_work_info['pic_or_video'] == 1){ ?>class="copyright-selected"<?php } ?>
                                        data="1">
                                        <a class="clearfix">
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 2 && $_work_info['pic_or_video'] == 1){ ?>class="copyright-selected"<?php } ?>
                                        data="2">
                                        <a class="clearfix">
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 3 && $_work_info['pic_or_video'] == 1){ ?>class="copyright-selected"<?php } ?>
                                        data="3">
                                        <a class="clearfix">
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 0 && $_work_info['pic_or_video'] == 1){ ?>class="copyright-selected"<?php } ?>
                                        data="0">
                                        <a class="clearfix">
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 4 && $_work_info['pic_or_video'] == 1){ ?>class="copyright-selected"<?php } ?>
                                        data="4">
                                        <a class="clearfix">
                        ...
                        <div class="upload-content-operate clearfix">
                            <input type="hidden" name="work[work_id]"
                                   value="<?php echo !empty($_work_info['work_id']) ? $_work_info['work_id'] : ''; ?>"
                                   autocomplete="off"/>
                            <input type="hidden" name="work[picorvideo]" value="1" autocomplete="off"/>
                            <input type="hidden" name="work[work_group_id]"
                                   value="<?php echo !empty($_work_info['p_work_id']) ? $_work_info['p_work_id'] : ''; ?>"
                                   autocomplete="off"/>
                            <input type="hidden" name="work[open_status]"
                                   value="<?php echo !empty($_work_info['copyright']) ? $_work_info['copyright'] : ''; ?>"
                                   autocomplete="off"/>
                            <a class="operate-cancel _go_work_list" href="<?php echo yii::$app->urlManager->createUrl(['personal/index']) .'/'. $username;?>">返回</a>
                            <a class="operate-release _submit_work_form" href="javascript:void(0);">确定</a>
                        </div>
                    </form>
                </div>
                <!--/图片 -->
                ...
                <div class="rc-upload-content active">
                    <form action="" method="post" class="_work_form">
                        <div id="uploader_videocover" class="clearfix">
                            <?php if (!empty($_work_info['cover_url']))
                            { ?>
                                <div class="rc-videoCoverList">
                                    <img src="<?php echo $_work_info['cover_url'];?>">
                                    <input type="hidden" name="work[cover_url]"
                                           value="<?php echo $_work_info['cover_url'];?>"/>
                                </div>
                                <div class="videoCoverPicker-right">
                                    <div id="rc_videoCoverPicker" class="up-after">修改封面</div>
                                </div>
                            <?php }
                            else
                            { ?>
                            ...
                            <div class="videoCoverPicker-right">10MB以内/RGB模式</div>
                        ...
                        <div id="uploader_video">
                            <div class="uploader-video-link active">
                                <input type="text" class="form-control" name="work[work_link]" autocomplete="off"
                                       value="<?php echo empty($_work_info['work_link']) ? '' : $_work_info['work_link']; ?>"/>
                        ...
                        <div class="upload-content-msg">
                            <div class="upload-content-category dropdown">
                                <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                    <span class="samplereels">
                                        <?php echo empty($_work_group_list[$_work_info['p_work_id']]) ? '选择所属作品集' : $_work_group_list[$_work_info['p_work_id']]['work_name']; ?>
                                    </span>
                                    <span class="caret"></span>
                                </button>
                                <ul class="dropdown-menu _work_group_list" aria-labelledby="dropdownMenu1">
                        ...
                        <div class="upload-content-msg">
                            <script type="text/plain" id="editor_upload_video" name="work[content]"
                                    style="margin:10px 0;"><?php if ($_work_info['pic_or_video'] == 2)
                                {
                                    echo $_work_info['description'];
                                } ?></script>
                        </div>
                        ...
                        <div class="upload-content-setting clearfix">
                            <div class="upload-content-copyright dropup">
                                ...
                                <ul class="dropdown-menu _chose_open_status" aria-labelledby="dLabel">
                                    <li <?php if ($_work_info['copyright'] == 3 && $_work_info['pic_or_video'] == 2){ ?>class="copyright-selected"<?php } ?>
                                        data="3">
                                        <a class="clearfix">
                                            <i class="copyright-icon copyright-icon-3"></i>
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 0 && $_work_info['pic_or_video'] == 2){ ?>class="copyright-selected"<?php } ?>
                                        data="0">
                                        <a class="clearfix">
                                            <i class="copyright-icon copyright-icon-4"></i>
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 4 && $_work_info['pic_or_video'] == 2){ ?>class="copyright-selected"<?php } ?>
                                        data="4">
                                        <a class="clearfix">
                                            <i class="copyright-icon copyright-icon-5"></i>
                        ...
                        <div class="upload-content-operate clearfix">
                            ...
                            <input type="hidden" name="work[work_url]"
                                   value="<?php echo !empty($_work_info['work_url']) ? $_work_info['work_url'] : ''; ?>"
                                   autocomplete="off"/>
                    ...
                    <form action="" method="post" class="_work_form">
                        ...
                        <div class="upload-content-msg">
                            <script type="text/plain" id="editor_upload_txt" name="work[content]"
                                    style="margin:10px 0;"><?php if ($_work_info['pic_or_video'] == 3)
                                {
                                    echo $_work_info['description'];
                                } ?></script>
                        </div>
                        ...
                        <div class="upload-content-setting clearfix">
                            <div class="upload-content-copyright dropup">
                                ...
                                <ul class="dropdown-menu _chose_open_status" aria-labelledby="dLabel">
                                    <li <?php if ($_work_info['copyright'] == 2 && $_work_info['pic_or_video'] == 3){ ?>class="copyright-selected"<?php } ?>
                                        data="2">
                                        <a class="clearfix">
                                            <i class="copyright-icon copyright-icon-2"></i>
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 3 && $_work_info['pic_or_video'] == 3){ ?>class="copyright-selected"<?php } ?>
                                        data="3">
                                        <a class="clearfix">
                                            <i class="copyright-icon copyright-icon-3"></i>
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 0 && $_work_info['pic_or_video'] == 3){ ?>class="copyright-selected"<?php } ?>
                                        data="0">
                                        <a class="clearfix">
                                            <i class="copyright-icon copyright-icon-4"></i>
                                    ...
                                    <li <?php if ($_work_info['copyright'] == 4 && $_work_info['pic_or_video'] == 3){ ?>class="copyright-selected"<?php } ?>
                                        data="4">
                                        <a class="clearfix">
                                            <i class="copyright-icon copyright-icon-5"></i>
...
<script>
    $(function () {
        $(".uploader-video-link input").next("label").addClass('hide');
        $('._submit_work_form').click(function () {
            $(this).parents('._work_form').ajaxSubmit({
                url: '<?php echo yii::$app->urlManager->createUrl(['personal/work/update'])?>',
                data: $(this).serialize(),
                type: "POST",
                dataType: 'json',
                ...
                success: function (data) {
                    if (data.ret == '0001') {
                        _show_tips_win('提示窗口', '修改成功！', 3, function (d) {
        ...
        $('._go_work_list').click(function () {
            if (confirm('当前表单数据尚未保存，确定要返回作品列表？')) {
                return true;
            }
            else {
                return false;
...
//                    chunkSize: '5',
                ...
                picUploader.on('fileQueued', function (file) {
                    ...
                    $('#rc_pictureList').find(".uploader-listitem:first").remove();
                    _list.append(_li);
                    _list.next("#rc_picturePicker").find(".webuploader-pick").html('<p class="rc-picturePicker-txt"><i class="icon-13 icon-13-blueadd"></i>上传文件</p>').closest('#uploader_picture').addClass('uploader-one');
                });
                // 文件上传过程中创建进度条实时显示(图片)
                ...
                picUploader.on('uploadSuccess', function (file, response) {
                    ...
                    var _input = '';
                    if (_file_ret == '13900') {
                        _input = '<input type="hidden" name="work[workfile]" value="' + _file_path + '" />';
                    }
                    var _li = $("#" + file.id), _img;
                ...
                $(".uploader-list").on('click', '.uploader-listitem-close', function (event) {
                    ...
                    _obj.remove();
                    _list.find('.uploader-listitem').find('.showremark-btn').remove();
...
//                    chunkSize: '5',
                ...
                coverUploader.on('uploadSuccess', function (file, response) {
                    ...
                    var _input = '';
                    if (_file_ret == '13900') {
                        _input = '<input type="hidden" name="work[cover_url]" value="' + _file_path + '" />';
                    }
                    var _li = $("#" + file.id),
                        _img;
                    _li.html("<img>" + _input);
...
//                    chunkSize: '5',
                ...
                // 文件添加进来的时候(视频)
                videoUploader.on('fileQueued', function (file, response) {
...
//                    _obj.addClass('copyright-dark').find('i').removeClass().addClass(iconClass).next('.copyright-desc').html(txt);
                ...
                //初始化版权设置
                $('.upload-content-copyright .dropdown-menu').find('li').each(function (event) {
                    var _this = $(this),
                        _obj = $(".upload-content-copyright .copyright-btn"),
                        iconClass = _this.find('i').prop("className"),
                        txt = _this.find('.copyright-desc').html();
                    if (_this.hasClass('copyright-selected')) {
                        _obj.addClass('copyright-dark').find('i').attr('class', '').addClass(iconClass).next('.copyright-desc').html(txt);
                        return false;
                    }
                });
                        ...
                        var _this = $(this),
                            myHtml = '<div class="uploader-listitem-remarkbox">\
                                    ...
                                    <div class="remarkbox-input">\
                                        <input type="text" class="form-control" placeholder="TO：对单个作品描述">\
                                    </div>\
                ...
                $('.uploader-video-link').on('click', function (event) {
                    var _this = $(this);
