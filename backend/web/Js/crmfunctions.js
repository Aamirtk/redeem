...
$(function () {
    ...
    BUI.use(['bui/grid', 'bui/data'], function (Grid, Data) {
        ...
        var grid = new Grid.Grid({
            ...
            selectedEvent: 'click',
            columns: [
                {title: '企业编号', dataIndex: 'id', width: 70},
                {
                    title: '企业名称',
                    dataIndex: 'name',
                    width: 160,
                ...
                {title: '创意云注册ID', dataIndex: 'username', width: 90},
                {title: '企业电话', dataIndex: 'tel', width: 90},
                {title: '入驻类型', dataIndex: 'create_type', width: 70,
                    renderer: function (v) {
                        return v==1 ? 'CRM录入': '前台入驻';
                    }},
