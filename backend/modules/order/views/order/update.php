...
<div class="demo-content">
    <form id="Order_Form" action="" class="form-horizontal" onsubmit="return false;" >
                ...
                <div id="thumbpic-content" class="layout-content" aria-disabled="false" aria-pressed="false" >
                    <?php if(!empty($order['thumb'])): ?>
                        <div id="" class=" pull-left img-content-li">
                            <a href="javaScript:;"><span class="label label-important img-delete" file-path="<?php echo $order['thumb'] ?>">删除</span></a>
                            <div aria-disabled="false"  class="" aria-pressed="false">
                                <img  src="<?php echo $order['thumb'] ?>" />
                                <input type="hidden" name="order[thumb]" value="<?php echo $order['thumb'] ?>">
                                <p></p>
                            </div>
                        </div>
                    <?php endif ?>
        ...
        <div class="row" >
            <div class="span16 layout-outer-content">
                <div id="thumblistpic-content" class="layout-content content-list" aria-disabled="false" aria-pressed="false" >
                    <?php $thumb_list = json_decode($order['thumb_list']);?>
                        ...
                        <?php foreach($thumb_list as $k => $val): ?>
                            <div id="" class=" pull-left img-content-li">
                                ...
                                <div aria-disabled="false"  class="" aria-pressed="false">
                                    ...
                                    <input type="hidden" name="order[thumb_list]" value="<?php echo $val ?>">
                                    <p></p>
                                </div>
                            </div>
                        <?php endforeach ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="order[redeem_pionts]" type="text" class="input-medium" data-rules="{number:true}" value="<?php echo $order['redeem_pionts'] ?>">
            </div>
        </div>
        <div class="control-group">
        ...
        BUI.use('bui/form',function(Form){
            ...
            $("#save-order").on('click', function(){
                if(form.isValid()){
                    ...
                    $._ajax('/order/order/update', param, 'POST', 'JSON', function(json){
                        if(json.code > 0){
