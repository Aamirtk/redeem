        ...
        <div class="well">
            ...
            <div id="vip_content" style="display:block;">
                <form id="vip_form" class="form-horizontal"
                    ...
                    <!--其他参数-->
                    <input name="action_type" type="hidden" value="add"/>
                    <input name="vip_id" type="hidden" value="0"/>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="name" class="input-normal control-text" v-role="name"
                                       data-rules="{required:true,valid_name:5}" type="text"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="phone" class="input-normal control-text" v-role="phone"
                                       data-rules="{required:true, number:true}" data-messages="{number:'不是有效号码'}"  type="text"/>
                            </div>
                        </div>
                        <div class="control-group">
                                ...
                                <?php foreach ($groups as $k => $v)
                                {
                                    ...
                                    <label class="radio">
                                        <input type="radio" name="group_id" v-role="group_id" class="basic_score_value"
                                               data-rules="{required:true}" value="<?= $v['id'] ?>"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="price" class="input-normal control-text " v-role="price"
                                       disabled="disabled" data-rules="{required:true}" value="0" type="text"/>
                            </div>
                        </div>
                        <div class="control-group">
...
<script type="text/javascript">
    BUI.use('bui/form', function (Form) {
        ...
        var userfield = form.getField('username');
        userfield.set('remote', {
            url : '/vip/vip/ajax-check-user',
            dataType:'json',//默认为字符串
            callback : function(data){
                if (!data.result && data.errorMessage.errors) {
                    return data.errorMessage.errors;
                }
            }
        });
